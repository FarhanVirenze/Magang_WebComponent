        ...
        <div class="section">
          ...
          <div class="grid-buttons">
            ${this.generateButtons([
              ["highlight-title", `<img src="${judulIcon}" alt="Sorot Judul"/>`, "title"],
...
readerToggle?.addEventListener("click", () => {
  ...
  if (contentWrapper) {
    contentWrapper.classList.remove(
      ...Array.from(contentWrapper.classList).filter((cls) => cls.startsWith("font-scale-"))
    );
  ...
  const toggleContainer = this.querySelector('#accessibility-toggle') as HTMLElement;
